...
public class GobangGame extends JFrame{
    ...
    private GobangSettingSaver settingSaver;
    private GobangSettingLoader settingLoader;
    ...
    public void setSettingSaver(GobangSettingSaver settingSaver) {this.settingSaver = settingSaver;}
    public void setSettingLoader(GobangSettingLoader settingLoader) {this.settingLoader = settingLoader;}
    // 模块 Getter
    public GobangGameAi getAi() { return ai; }
    public GobangGameUI getUi() { return ui; }
    public GobangGameHandler getHandler() { return handler; }
    public GobangSettingSaver getSettingSaver() { return settingSaver; }
    public GobangSettingLoader getSettingLoader() { return settingLoader; }
